...
class RevocationCheckerTests(unittest.TestCase):
    ...
    def test_does_not_use_ingredient_result_for_active_signer(self):
        results = {
            "activeManifest": {
                "success": [
                    {
        ...
        # This represents an aggregated status belonging to
        # another manifest or ingredient.
        aggregated_status = [
            {
                "code":
                "signingCredential.revoked"
        ...
        result = check_certificate_revocation(
            results,
            aggregated_status,
        )
